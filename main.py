...
from utils.graph_visualizer import  FlightGraphVisualizer
...
def main():
    ...
    # Włączenie trybu interaktywnego Matplotlib
    # Uruchomienie dynamicznej wizualizacji z burzami
    visualizer = FlightGraphVisualizer(booking_service)
    visualizer.run()

    # Dynamiczne aktualizacje z burzami
